...
namespace _06_02_EntityFramework
{
    public class AirplaneDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer(@"Data Source=10.7.101.197;Initial Catalog = AirPortDataBase;User ID=sa;Password=Qwerty-1;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Airplane>().HasOne(a => a.City).WithMany(c => c.Airplanes).HasForeignKey(c=>c.CityId);
            ...
            modelBuilder.Entity<Accounts>().HasOne(a => a.Client).WithOne(c => c.Accounts).HasForeignKey<Client>(c => c.AccountsId);
            ...
            modelBuilder.Entity<City>().HasMany(c => c.Flight).WithOne(f => f.Cities).HasForeignKey(f => f.CityId);
